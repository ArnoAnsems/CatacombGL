...
public:
    ...
    SDL_GamepadButton GetFirstGameControllerButtonPressed() const;
    SDL_GamepadAxis GetFirstGameControllerAxisPressed() const;
    void SetHasFocus(const bool focus);
    bool HasFocus() const;
    void ClearAll();
    void SetGameControllerButtonPressed(const SDL_GamepadButton gameControllerButton, const bool pressed);
    bool IsGameControllerButtonJustPressed(const SDL_GamepadButton gameControllerButton) const;
    bool IsGameControllerButtonPressed(const SDL_GamepadButton gameControllerButton) const;
    int16_t GetGameControllerAxisPressed(const SDL_GamepadAxis gameControllerAxis) const;
    void SetGameControllerAxisPressed(const SDL_GamepadAxis gameControllerAxis, const int16_t value);
    bool GetGameControllerAxisJustPressedTowardsNegative(const SDL_GamepadAxis gameControllerAxis) const;
    bool GetGameControllerAxisJustPressedTowardsPositive(const SDL_GamepadAxis gameControllerAxis) const;
...
private:
    ...
    std::map<SDL_GamepadButton, bool> m_gameControllerButtonPressed;
    std::map<SDL_GamepadButton, bool> m_gameControllerButtonJustPressed;
    ...
    bool m_hasFocus;
    std::map<SDL_GamepadAxis, int16_t> m_gameControllerAxisPressed;
    std::map<SDL_GamepadAxis, bool> m_gameControllerAxisJustPressedTowardsNegative;
    std::map<SDL_GamepadAxis, bool> m_gameControllerAxisJustPressedTowardsPositive;
