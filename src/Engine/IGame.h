...
public:
    ...
    virtual void DrawStatusBar(const int16_t health, const std::string& locationMessage, const PlayerInventory& playerInventory, const uint16_t wideScreenMargin, const float playerAngle, const uint8_t levelIndex, const uint16_t shotPower) = 0;
    ...
    virtual IMenu* CreateMenu(ConfigurationSettings& configurationSettings, std::vector<std::string>& savedGames) = 0;
