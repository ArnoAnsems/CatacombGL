...
private:
    ...
    bool m_present;
    std::string m_name;
    int16_t m_freezeTime = 0;
    int16_t m_difficulty = 0;
    int16_t m_mapOn = 0;
    int16_t m_bolts = 0;
    int16_t m_nukes = 0;
    int16_t m_potions = 0;
    int16_t m_keys[4] = { 0, };
    int16_t m_scrolls[8] = { 0, };
    int16_t m_gems[5] = { 0, };
    int32_t m_score = 0;
    int16_t m_body = 0;
    int16_t m_shotpower = 0;
    bool m_easyModeOn = false;
    uint16_t m_skycolor = 0;
    uint16_t m_groundcolor = 0;
    int16_t m_mapWidth = 0;
    int16_t m_mapHeight = 0;
    FileChunk* m_plane0 = nullptr;
    FileChunk* m_plane2 = nullptr;
    uint16_t m_numberOfObjects = 0;
