...
const std::vector<WallInfo> wallsInfoAbyss =
{
    ...
    { {W_NEMPICEWPIC}, {W_NEMPICEWPIC}, WTSolid },
    { {W_PENTAEWPIC}, {W_PENTANSPIC}, WTSolid },
    // 4 and 5: Bloody altar
    { {W_ALTER_LFPIC}, {W_ALTER_LFPIC}, WTSolid },
    { {W_ALTER_RTPIC}, {W_ALTER_RTPIC}, WTSolid },
    // 6, 7 and 8: Wall skeleton
    { {W_SUB1EWPIC}, {W_SUB1NSPIC}, WTSolid },
    { {W_SUB2EWPIC}, {W_SUB2NSPIC}, WTSolid },
    { {W_SUB3EWPIC}, {W_SUB3NSPIC}, WTSolid },
    ...
    { {W_LSUB_STONEPIC}, {W_DSUB_STONEPIC}, WTSolid },
    { {W_BLOODY_LSUB_STONEPIC}, {W_BLOODY_DSUB_STONEPIC}, WTSolid },
    ...
    { {W_WOOD_DOORWAYPIC}, {W_WOOD_DOORWAYPIC}, WTDoor },
    { {W_WOOD_DOORWAY_GLOWPIC}, {W_WOOD_DOORWAY_GLOWPIC}, WTDoorRedKeyRequired },
    ...
    { {W_WOODEN_DOORPIC}, {W_WOODEN_DOORPIC}, WTDoor },
    { {W_WOOD_DOOREWPIC}, {W_WOOD_DOOREWPIC}, WTDoor },
    { {W_METAL_DOORPIC}, {W_METAL_DOORPIC}, WTDoor },
    { {W_GLOW_DOORPIC}, {W_GLOW_DOORPIC}, WTDoor },
    // 28: Final exit gate to the surface
    { {W_FINALEXITPIC}, {W_FINALEXITPIC}, WTVictory },
    ...
    { {W_PRE_CHEATSPIC}, {W_CHEAT_GODPIC}, WTSolid },
    { {W_CHEAT_WARPPIC}, {W_CHEAT_ITEMSPIC}, WTSolid },
    { {W_CHEAT_FREEZEPIC}, {W_POST_CHEATPIC}, WTSolid },
    { {W_SURFACE_PLAQPIC}, {W_SURFACE_PLAQPIC}, WTSolid },
    // 36: Water gate
    { {W_WATER_GATEEW1PIC, W_WATER_GATEEW2PIC}, {W_WATER_GATENS1PIC, W_WATER_GATENS2PIC}, WTDoor },
    { {WALL8LPIC}, {WALL8DPIC}, WTSolid },
    { {WALL9LPIC}, {WALL9DPIC}, WTSolid },
    { {WALL10DPIC}, {WALL10LPIC}, WTSolid },    // Note: L and D are swapped, just like in C4_DRAW.C!
    { {WALL11LPIC}, {WALL11DPIC}, WTSolid },
    // 41, 42, 43 and 44: Wall skeleton
    { {WALL12LPIC}, {WALL12DPIC}, WTSolid },
    { {WALL13LPIC}, {WALL13DPIC}, WTSolid },
    { {WALL14LPIC}, {WALL14DPIC}, WTSolid },
    { {WALL15LPIC}, {WALL15DPIC}, WTSolid },
    { {WALL16LPIC}, {WALL16DPIC}, WTSolid },
    { {WALL17LPIC}, {WALL17DPIC}, WTSolid },
    { {W_WINDOWEWPIC}, {W_WINDOWNSPIC}, WTSolid },
    { {WALL19LPIC}, {WALL19DPIC}, WTSolid },
    { {WALL20LPIC}, {WALL20DPIC}, WTSolid },
    { {WALL21LPIC}, {WALL21DPIC}, WTSolid },
    // 51: generic door
    { {WALL22LPIC}, {WALL22DPIC}, WTDoor },
    { {WALL23LPIC}, {WALL23DPIC}, WTSolid },
    { {WALL24LPIC}, {WALL24DPIC}, WTSolid },
    // 54: DOWN stairs
    { {WALL25LPIC}, {WALL25DPIC}, WTDoor },
    { {WALL26LPIC}, {WALL26DPIC}, WTSolid },
    // 56: UP stairs
    { {WALL27LPIC}, {WALL27DPIC}, WTDoor },
    { {WALL28LPIC}, {WALL28DPIC}, WTSolid },
    { {WALL29LPIC}, {WALL29DPIC}, WTSolid },
    { {WALL30LPIC}, {WALL30DPIC}, WTSolid },
    { {WALL31LPIC}, {WALL31DPIC}, WTSolid },
    ...
    // Statues
    { {MAGE_STATUEPIC}, {MAGE_STATUEPIC}, WTSolid },
    { {ZOMBIE_STATUEPIC}, {ZOMBIE_STATUEPIC}, WTSolid },
    { {EYE_STATUEPIC}, {EYE_STATUEPIC}, WTSolid },
    { {NEM_STATUEPIC}, {NEM_STATUEPIC}, WTSolid },
    { {SKELETON_STATUEPIC}, {SKELETON_STATUEPIC}, WTSolid },
    { {SPOOK_STATUEPIC}, {SPOOK_STATUEPIC}, WTSolid },
