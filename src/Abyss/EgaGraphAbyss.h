...
const huffmanTable egaDictionaryAbyssv112 =
{
    { 45, 209 },
    { 169, 162 },
    { 172, 150 },
...
const std::vector<int32_t> egaGraphOffsetsAbyssv112 =
{
    0,
    712,
    720,
...
typedef enum {
    ...
    FIRSTTILESIZE16 = 317,
    LASTTILESIZE16 = 531,
    FIRSTTILESIZE16MASKED = 534,
    LASTTILESIZE16MASKED = 604,
    LEVEL1TEXT=605,
    LEVEL2TEXT,                  // 606
    LEVEL3TEXT,                  // 607
    LEVEL4TEXT,                  // 608
...
const egaGraphStaticData egaGraphAbyssV112 =
{
    "EGAGRAPH.ABS",
    egaGraphOffsetsAbyssv112,
    egaDictionaryAbyssv112,
    FINALEPIC,
    FIRSTSCALEPIC,
    FIRSTWALLPIC,
    HAND1PICM - 1,
    NORTHICONSPR - 1,
    FIRSTTILESIZE8 - 1,
    FIRSTTILESIZE8MASKED - 1,
    FIRSTTILESIZE16 - 1,
    LASTTILESIZE16 - 1,
    FIRSTTILESIZE16MASKED - 1,
    LASTTILESIZE16MASKED - 1,
    LEVEL1TEXT - 1,
    LEVEL20TEXT - 1,
    HAND1PICM - 1
};

const egaGraphStaticData egaGraphAbyssV113 =
{
    "EGAGRAPH.ABS",
