...
void GuiElementBindGameControllerCat3D::Draw(IRenderer& renderer) const
{
    ...
    else
    {
        ...
        m_renderableText.LeftAligned(m_controlsMap.GetGameControllerStringFromAction(m_controlAction), m_selected ? EgaLightGray : EgaDarkGray, m_originX + m_offsetXValue, m_originY + 1);
    }
}