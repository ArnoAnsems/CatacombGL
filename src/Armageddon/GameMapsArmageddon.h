...
const std::vector<WallInfo> wallsInfoArmageddon =
{
    // 0: No wall
    { 0, 0, 0, 0, WTOpen },
    { CRYSTAL_LIGHT_1PIC, CRYSTAL_LIGHT_1PIC, CRYSTAL_DARK_1PIC, CRYSTAL_DARK_1PIC, WTSolid },
    { CRYSTAL_LIGHT_2PIC, CRYSTAL_LIGHT_2PIC, CRYSTAL_DARK_2PIC, CRYSTAL_DARK_2PIC, WTSolid },
    { CRYSTAL_LIGHT_3PIC, CRYSTAL_LIGHT_3PIC, CRYSTAL_DARK_3PIC, CRYSTAL_DARK_3PIC, WTSolid },
    { CRYSTAL_LIGHT_4PIC, CRYSTAL_LIGHT_4PIC, CRYSTAL_DARK_4PIC, CRYSTAL_DARK_4PIC, WTSolid },

    { FIRE_WALL_1PIC, FIRE_WALL_1PIC, FIRE_WALL_1PIC, FIRE_WALL_1PIC, WTSolid },
    { FIRE_WALL_2PIC, FIRE_WALL_2PIC, FIRE_WALL_2PIC, FIRE_WALL_2PIC, WTSolid },
    ...
    { ALTAR_RIGHTPIC, ALTAR_RIGHTPIC, ALTAR_RIGHTPIC, ALTAR_RIGHTPIC, WTSolid },
    { GRAY_LIGHT_WALLPIC, GRAY_LIGHT_WALLPIC, GRAY_DARK_WALLPIC, GRAY_DARK_WALLPIC, WTSolid },
    { GRAY_LIGHT_SIGNPIC, GRAY_LIGHT_SIGNPIC, GRAY_DARK_SIGNPIC, GRAY_DARK_SIGNPIC, WTSolid },

    { MANICLE_LIGHT_WALLPIC, MANICLE_LIGHT_WALLPIC, MANICLE_DARK_WALLPIC, MANICLE_DARK_WALLPIC, WTSolid },
    { MANICLE_LIGHT_BLOODYPIC, MANICLE_LIGHT_BLOODYPIC, MANICLE_DARK_BLOODYPIC, MANICLE_DARK_BLOODYPIC, WTSolid },

    { LIGHT_CURTAIN_WINDOWPIC, LIGHT_CURTAIN_WINDOWPIC, DARK_CURTAIN_WINDOWPIC, DARK_CURTAIN_WINDOWPIC, WTSolid },
    { LIGHT_CURTAIN_WALLPIC, LIGHT_CURTAIN_WALLPIC, DARK_CURTAIN_WALLPIC, DARK_CURTAIN_WALLPIC, WTSolid },
    { BRN_LIGHT_SIGNPIC, BRN_LIGHT_SIGNPIC, BRN_DARK_SIGNPIC, BRN_DARK_SIGNPIC, WTSolid },
    ...
    { RUST_METAL_LIGHTPIC, RUST_METAL_LIGHTPIC, RUST_METAL_DARKPIC, RUST_METAL_DARKPIC, WTSolid },
    { GRAY_METAL_LIGHTPIC, GRAY_METAL_LIGHTPIC, GRAY_METAL_DARKPIC, GRAY_METAL_DARKPIC, WTSolid },

    { WEAK_STONE_LIGHTPIC, WEAK_STONE_LIGHTPIC, WEAK_STONE_DARKPIC, WEAK_STONE_DARKPIC,  WTSolid },

    { DMG_FIN_FSTN_LTPIC, DMG_FIN_FSTN_LTPIC, DMG_FIN_FSTN_DKPIC, DMG_FIN_FSTN_DKPIC, WTSolid },

    { WEAK_GRAY_RFGSTN_LIGHTPIC, WEAK_GRAY_RFGSTN_LIGHTPIC, WEAK_GRAY_RFGSTN_DARKPIC, WEAK_GRAY_RFGSTN_DARKPIC, WTSolid },
    { 0, 0, 0, 0, WTOpen },

    { WEAK_CRYSTAL_LIGHTPIC, WEAK_CRYSTAL_LIGHTPIC, WEAK_CRYSTAL_DARKPIC, WEAK_CRYSTAL_DARKPIC, WTSolid },
    ...
    { WATER_LIGHT_WEAK_3PIC, WATER_LIGHT_WEAK_3PIC, WATER_DARK_WEAK_3PIC, WATER_DARK_WEAK_3PIC, WTSolid },

    { WATER_LIGHT_1PIC, WATER_LIGHT_1PIC, WATER_DARK_1PIC, WATER_DARK_1PIC, WTSolid },
    ...
    { EXP_WALL_1PIC, EXP_WALL_1PIC, EXP_WALL_1PIC, EXP_WALL_1PIC, WTSolid },
    { EXP_WALL_2PIC, EXP_WALL_2PIC, EXP_WALL_2PIC, EXP_WALL_2PIC, WTSolid },
    { EXP_WALL_3PIC, EXP_WALL_3PIC, EXP_WALL_3PIC, EXP_WALL_3PIC, WTSolid },

    { WATER_EXP_WALL_1PIC, WATER_EXP_WALL_1PIC, WATER_EXP_WALL_1PIC, WATER_EXP_WALL_1PIC, WTSolid },
