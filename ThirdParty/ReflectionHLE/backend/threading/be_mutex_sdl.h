...
static inline void BE_ST_LockMutexRecursively(BE_ST_Mutex_T *mutex) { SDL_LockMutex(mutex); }
static inline void BE_ST_UnlockMutexRecursively(BE_ST_Mutex_T *mutex) { SDL_UnlockMutex(mutex); }
